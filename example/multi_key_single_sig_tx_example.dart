...
const String TestAddress = 'ckt1qyqvsv5240xeh85wvnau2eky8pwrhh4jr8ts8vyj37';
Api api;
...
List<Receiver> receivers1 = [
  Receiver(Addresses[2], ckbToShannon(number: 800)),
  Receiver(Addresses[3], ckbToShannon(number: 90000)),
  Receiver(Addresses[4], ckbToShannon(number: 100000))
];
