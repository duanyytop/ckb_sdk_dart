...
main() async {
  ...
  List<Receiver> receivers = [
          Receiver(
              "ckt1qyqqtdpzfjwq7e667ktjwnv3hngrqkmwyhhqpa8dav", BigInt.parse("10000000000")),
          Receiver(
              "ckt1qyq9ngn77wagfurp29738apv738dqgrpqpssfhr0l6", BigInt.parse("12000000000")),
          Receiver(
              "ckt1qyq2pmuxkr0xwx8kp3ya2juryrygf27dregs44skek", BigInt.parse("15000000000"))];

  String balance = (await getBalance(api, senderAddress)).toString();
  print('Sender balance before transferring:  $balance');
  ...
  print('Sender balance after transferring:  $balance1');
}
...
Future<String> sendCapacity(Api api, String privateKey, List<Receiver> receivers) async {
