...
void main() {
  ...
  group('A group tests of calculator', () {
    setUp(() {
      var cellInputs = [
        CellInput(previousOutput: OutPoint(txHash: '0x91fcfd61f420c1090aeded6b6d91d5920a279fe53ec34353afccc59264eeddd4', index: '0x0'), since: '113'),
        CellInput(previousOutput: OutPoint(txHash: '0x00000000000000000000000000004e4552564f5344414f494e50555430303031', index: '0x0'), since: '0x0')
      ];
      ...
      tx = Transaction(
          version: '0x0',
          cellDeps: [CellDep(outPoint: OutPoint(txHash: '0xbffab7ee0a050e2cb882de066d3dbf3afdd8932d6a26eda44f06e4b23f0f4b5a', index: '0x1'), depType: CellDep.DepGroup)],
          headerDeps: ['0x'],
          inputs: cellInputs,
          outputs: cellOutputs,
          outputsData: ['0x'],
