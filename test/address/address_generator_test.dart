...
void main() {
  group('A group tests of address generator', () {
    ...
    test('Generate testnet address with any arg', () {
      var singleSigShortScript = Script(codeHash: '0x9bd7e06f3ecf4be0f2fcd2188b23f1b9fcc88e5d4b65a8637b17723bbda3cce8', args: '0x36c329ed630d6ce750712a477543672adab57f4c', hashType: Script.Type);
